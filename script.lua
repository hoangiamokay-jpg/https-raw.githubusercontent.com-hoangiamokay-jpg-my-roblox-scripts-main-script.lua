...
Tabs.Main2:AddButton({
    Title="no name",
    Callback=function()
        loadstring(game:HttpGet("https://rawscripts.net/raw/NOLI-Forsaken-Op-script-Auto-Farm-and-more-49047"))()
    end
})
Tabs.Main2:AddButton({
    Title="no name",
    Callback=function()
        loadstring(game:HttpGet("https://rawscripts.net/raw/Forsaken-Plus-216770"))()
    end
})
-- Tab 3: Coming soon zombie arena 
Tabs.Main3:AddButton({
    Title=" zombie arena coming soon ",
    Callback=function()
